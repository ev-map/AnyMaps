 ...
 */
public class PolylineOptionsMapper implements Mapper<PolylineOptions, com.google.android.libraries.maps.model.PolylineOptions> {

	@Override
	public com.google.android.libraries.maps.model.PolylineOptions map(PolylineOptions input) {
		List<LatLng> points = AnyMapAdapter.adaptList(com.car2go.maps.model.LatLng.class, input.getPoints());

		return new com.google.android.libraries.maps.model.PolylineOptions()
