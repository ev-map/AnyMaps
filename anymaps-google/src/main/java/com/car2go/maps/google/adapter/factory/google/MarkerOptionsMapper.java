 ...
 */
public class MarkerOptionsMapper implements Mapper<MarkerOptions, com.google.android.libraries.maps.model.MarkerOptions> {

	@Override
	public com.google.android.libraries.maps.model.MarkerOptions map(MarkerOptions input) {
		LatLng googleLatLng = AnyMapAdapter.adapt(input.getPosition());

		return new com.google.android.libraries.maps.model.MarkerOptions()
