 ...
 */
public class LatLngBoundsMapper implements Mapper<LatLngBounds, com.google.android.libraries.maps.model.LatLngBounds> {

	@Override
	public com.google.android.libraries.maps.model.LatLngBounds map(LatLngBounds input) {
		LatLng southWest = AnyMapAdapter.adapt(input.southwest);
		LatLng northEast = AnyMapAdapter.adapt(input.northeast);

		return new com.google.android.libraries.maps.model.LatLngBounds(southWest, northEast);
	}
