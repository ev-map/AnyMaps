...
class DrawableComponentFactory {
	...
	public Marker addMarker(MarkerOptions options) {
		com.google.android.libraries.maps.model.MarkerOptions googleOptions = AnyMapAdapter.adapt(options);
		com.google.android.libraries.maps.model.Marker marker = map.addMarker(googleOptions);
	...
	public Circle addCircle(CircleOptions options) {
		com.google.android.libraries.maps.model.CircleOptions googleOptions = AnyMapAdapter.adapt(options);
		com.google.android.libraries.maps.model.Circle circle = map.addCircle(googleOptions);
	...
	public Polygon addPolygon(PolygonOptions options) {
		com.google.android.libraries.maps.model.PolygonOptions googleOptions = AnyMapAdapter.adapt(options);
		com.google.android.libraries.maps.model.Polygon polygon = map.addPolygon(googleOptions);
	...
	public Polyline addPolyline(PolylineOptions options) {
		com.google.android.libraries.maps.model.PolylineOptions googleOptions = AnyMapAdapter.adapt(options);
		com.google.android.libraries.maps.model.Polyline polyline = map.addPolyline(googleOptions);
